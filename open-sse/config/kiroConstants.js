 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what hiperrouter needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a hiperrouter
...
/**
 * Detect whether a model id refers to a hiperrouter synthetic agentic variant.
...
/**
 * Detect whether a model id is a hiperrouter synthetic thinking variant
...
/**
 * Resolve a hiperrouter model id to the real upstream Kiro model id, plus flags
