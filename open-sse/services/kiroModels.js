 ...
 * into hiperrouter-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are hiperrouter fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic hiperrouter variant set for a single upstream Kiro model.
 *
 ...
 * into hiperrouter variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
