...
const hasHiperRouterConfig = (settings) => Boolean(settings?.model?.base_url);
...
export async function DELETE() {
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "hiperrouter model slots removed from Grok Build",
    });
  } catch (error) {
