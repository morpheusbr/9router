...
const PROVIDER_NAME = "hiperrouter";
...
// Build TOML config for HiperRouter (openai provider mode)
const buildHiperRouterConfig = (baseUrl, apiKey, model) => {
...
// Detect HiperRouter by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildHiperRouterConfig(baseUrl, apiKey || "sk_hiperrouter", model);
