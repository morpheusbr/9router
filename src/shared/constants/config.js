...
export const GITHUB_CONFIG = {
  changelogUrl: "https://raw.githubusercontent.com/decolua/hiperrouter/refs/heads/master/CHANGELOG.md",
  donateUrl: "https://hiperrouter.com/api/donate",
};

// Updater configuration
export const UPDATER_CONFIG = {
  npmPackageName: "hiperrouter",
  installCmd: "npm i -g hiperrouter",
  installCmdLatest: "npm i -g hiperrouter@latest --prefer-online",
