...
HiperRouterをClaude Code CLIと統合し、AnthropicのAPIリクエストをHiperRouterのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはHiperRouterモデルにマッピングされる以下のモデルエイリアスをサポート:
...
1. モデル名がHiperRouterの設定と一致しているか確認
