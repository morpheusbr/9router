...
HiperRouterに関する一般的な質問。

---

## HiperRouterとは?

**HiperRouterは、サブスクリプションの価値を最大化し、コストを最小限に抑えるAIモデルルーターです。**
...
**はい、HiperRouter自体は100%無料でオープンソースです。**
...
**HiperRouterはすべてのプロバイダーのクォータをリアルタイムで追跡します:**
...
## HiperRouterをセルフホストできますか?

**はい! HiperRouterは複数のデプロイメントオプションをサポートします:**
