...
Common questions about HiperRouter.

---

## What is HiperRouter?

**HiperRouter is an AI model router that maximizes your subscription value and minimizes costs.**
...
**HiperRouter uses a 3-tier pricing strategy:**
...
**Yes, HiperRouter itself is 100% free and open source.**
...
**Yes! This is HiperRouter's core feature.**
...
**HiperRouter tracks quota in real-time for all providers:**
...
## Can I self-host HiperRouter?

**Yes! HiperRouter supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.HiperRouter`)
...
**Yes, HiperRouter prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.HiperRouter` (or custom `DATA_DIR`)
- No data sent to HiperRouter servers
...
**What HiperRouter stores:**
- Provider OAuth tokens (encrypted)
- API keys (encrypted)
- Usage statistics (local only)
- Combo configurations

**What HiperRouter does NOT store:**
...
- Backup `~/.HiperRouter` before major updates
