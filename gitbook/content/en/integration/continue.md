...
Integrate HiperRouter with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- HiperRouter API key from [dashboard](https://9router.com/dashboard)
- HiperRouter running (local or cloud)
...
### 2. Add HiperRouter Model Configuration
...
3. Choose your preferred HiperRouter model
...
- Check network latency to HiperRouter
