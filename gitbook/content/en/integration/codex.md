...
Integrate HiperRouter with OpenAI Codex CLI to route your OpenAI API requests through HiperRouter's intelligent routing system.
...
HiperRouter provides the following Codex models:
...
1. Verify your API key is correct in HiperRouter dashboard
...
1. Verify the model name matches your HiperRouter configuration
2. Check that the OpenAI provider connection is active in HiperRouter dashboard
...
Make sure you have configured your API key in the HiperRouter cloud dashboard.
