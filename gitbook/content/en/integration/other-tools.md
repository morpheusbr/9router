...
HiperRouter is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

HiperRouter provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to HiperRouter using these settings:

**Local HiperRouter:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any HiperRouter model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to HiperRouter
```bash
# Check if HiperRouter is running
...
- Check network connection to HiperRouter
