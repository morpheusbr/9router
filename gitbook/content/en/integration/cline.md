...
Integrate HiperRouter with Cline VSCode extension to route your AI requests through HiperRouter's intelligent routing system.

## Prerequisites

- Visual Studio Code installed
- Cline extension installed from VSCode marketplace
- HiperRouter running locally or cloud endpoint configured
...
Set the base URL to your HiperRouter endpoint:

**For Local HiperRouter:**
```
http://localhost:20128/v1
```

**For Cloud HiperRouter:**
```
https://9router.com
```

**Steps:**
1. In the **Base URL** field, enter your HiperRouter endpoint
...
1. In the **Model** dropdown, you can either:
   ...
   - Manually enter the model name from your HiperRouter configuration
...
4. Cline will use HiperRouter to process your request

### Code Generation

1. Ask Cline to generate code: "Create a React component for a login form"
2. Cline will generate code using HiperRouter
...
3. Get AI-powered explanations through HiperRouter

### File Operations

1. Ask Cline to create, modify, or delete files
2. Cline will use HiperRouter to understand context and make changes
...
1. Verify HiperRouter is running: `curl http://localhost:20128/health`
...
2. Verify your HiperRouter instance is running and healthy
3. Try reloading VSCode window (Cmd/Ctrl + Shift + P → "Reload Window")
4. Check HiperRouter logs for any errors

## Advanced Configuration

### Using Cloud Endpoint

To use HiperRouter cloud endpoint instead of localhost:

1. In Cline settings, set Base URL to: `https://9router.com`
2. Make sure you have configured your API key in the HiperRouter cloud dashboard
...
## Integration with HiperRouter Features

### Model Routing

HiperRouter automatically routes your requests to the best available provider based on:
- Model availability
...
If a provider fails, HiperRouter automatically falls back to alternative providers configured in your dashboard.

### Usage Tracking

Monitor your Cline usage through HiperRouter dashboard:
- Total requests
- Token usage
- Cost per model
