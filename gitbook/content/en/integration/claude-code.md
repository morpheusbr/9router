...
Integrate HiperRouter with Claude Code CLI to route your Anthropic API requests through HiperRouter's intelligent routing system.
...
Claude Code supports the following model aliases that map to HiperRouter models:
