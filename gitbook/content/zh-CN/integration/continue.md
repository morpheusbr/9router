...
将 HiperRouter 与 Continue 扩展集成,直接在 Visual Studio Code 中获得 AI 协助。

## 前置要求

- 已安装 Visual Studio Code
- 从 VSCode 市场安装了 Continue 扩展
- 来自 [仪表盘](https://9router.com/dashboard) 的 HiperRouter API key
- HiperRouter 正在运行(本地或云端)
