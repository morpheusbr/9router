...
关于 HiperRouter 的常见问题。

---

## 什么是 HiperRouter?

**HiperRouter 是一款 AI 模型路由工具,能够最大化你的订阅价值并最小化成本。**
