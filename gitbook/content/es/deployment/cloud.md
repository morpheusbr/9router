...
Despliega HiperRouter en VPS o Docker para acceso remoto y uso en producción.
...
| `DATA_DIR` | `~/.HiperRouter` | Ruta de almacenamiento de la base de datos |
...
# Si NO usas proxy reverso, permite los puertos de HiperRouter
...
```bash
# Verificar si HiperRouter está corriendo
pm2 status
