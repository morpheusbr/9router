...
Guía detallada de instalación de HiperRouter con consejos de solución de problemas.
...
Instala HiperRouter globalmente para usar desde cualquier lugar:
...
3. Se crea el directorio de datos en `~/.HiperRouter`
...
**Ubicación por defecto:** `~/.HiperRouter`
...
**Problema:** HiperRouter usa demasiada RAM
