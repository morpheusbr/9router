...
Integra HiperRouter con la extensión Continue para llevar la asistencia de IA directamente a Visual Studio Code.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Continue instalada desde el marketplace de VSCode
- API key de HiperRouter desde el [dashboard](https://9router.com/dashboard)
- HiperRouter ejecutándose (local o en la nube)
...
### 2. Agregar configuración de modelo de HiperRouter
...
```json
{
  "models": [
    {
      "title": "HiperRouter - Claude Opus (Best)",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key-from-dashboard",
      "apiBase": "http://localhost:20128/v1"
    ...
    {
      "title": "HiperRouter - Claude Sonnet (Balanced)",
      "provider": "openai",
    ...
    {
      "title": "HiperRouter - DeepSeek Chat (Code)",
      "provider": "openai",
    ...
    {
      "title": "HiperRouter - Claude Haiku (Fast)",
      "provider": "openai",
...
3. Elige tu modelo preferido de HiperRouter
...
```json
{
  "models": [
    {
      "title": "HiperRouter - Creative Writer",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key",
      "apiBase": "http://localhost:20128/v1",
...
- Verifica que HiperRouter esté corriendo: `curl http://localhost:20128/health`
...
- Selecciona el modelo correcto de HiperRouter
...
- Verifica la latencia de red hacia HiperRouter
