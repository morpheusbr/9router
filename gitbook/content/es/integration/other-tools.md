...
HiperRouter es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

HiperRouter proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a HiperRouter usando estas configuraciones:

**HiperRouter local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de HiperRouter (cc/*, cx/*, glm/*, etc.)
```

**HiperRouter en la nube:**
```
...
**Problema:** No se puede conectar a HiperRouter
```bash
# Verifica si HiperRouter está corriendo
...
**Solución:**
- Verifica que HiperRouter esté corriendo
...
- Verifica la conexión de red a HiperRouter
