...
Tích hợp HiperRouter với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model HiperRouter có sẵn:
...
### Connection Failed
- Xác minh HiperRouter đang chạy: `curl http://localhost:20128/health`
