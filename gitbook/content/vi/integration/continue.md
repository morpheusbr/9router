...
Tích hợp HiperRouter với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- HiperRouter API key từ [dashboard](https://9router.com/dashboard)
- HiperRouter đang chạy (cục bộ hoặc cloud)
...
### 2. Thêm Cấu hình Model HiperRouter
...
3. Chọn model HiperRouter ưa thích
...
- Kiểm tra HiperRouter đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến HiperRouter
