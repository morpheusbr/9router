...
HiperRouter tương thích với mọi công cụ hỗ trợ format API OpenAI. Hướng dẫn này bao gồm pattern tích hợp tổng quát cho nhiều công cụ và ứng dụng tùy chỉnh.

## Tổng quan

HiperRouter cung cấp API endpoint tương thích OpenAI hoạt động với:
...
Mọi công cụ tương thích OpenAI có thể kết nối đến HiperRouter bằng các cài đặt sau:
...
**Vấn đề:** Không kết nối được đến HiperRouter
```bash
...
**Giải pháp:**
- Xác minh HiperRouter đang chạy
...
- Kiểm tra kết nối network đến HiperRouter
