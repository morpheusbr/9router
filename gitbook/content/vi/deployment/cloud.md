...
Triển khai HiperRouter trên VPS hoặc Docker để truy cập từ xa và dùng trong production.
...
| `DATA_DIR` | `~/.HiperRouter` | Đường dẫn lưu database và data |
...
# If NOT using reverse proxy, allow HiperRouter ports
