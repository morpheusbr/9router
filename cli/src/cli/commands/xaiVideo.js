/**
 * `hiperrouter xai video` — generate a Grok Imagine video through the local
 * hiperrouter gateway and save the result as an MP4 file.
 *
...
const HELP = `
Usage: hiperrouter xai video --prompt "..." [options]

Generate a Grok Imagine video via your local hiperrouter gateway
...
Options:
  ...
  --api-key <key>         hiperrouter API key (or env NINE_ROUTER_API_KEY)
...
async function run(argv) {
  ...
  try {
    ...
    const connectionId = create.headers["x-hiperrouter-connection-id"] || null;
